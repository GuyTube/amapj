...
public class SDModeleEmail implements SearcherDefinition
{
	@Override
	public String getTitle()
	{
		return "Modèle de mail";
	}

	@Override
	public List<? extends Identifiable> getAllElements(Object params)
	{
		return MailerService.getAllModeleEmail();
	}
	...
	{
		ModeleEmail mm = (ModeleEmail) identifiable;
		return mm.getDesignation().name();
	}
