...
public class ProducteurVoirPart extends WizardFormPopup
{
	...
	protected void configure()
	{
		...
		add(Step.REFERENTS,()->addFieldReferents());
	}
	...
	private void addFieldGeneral()
	{
		...
		addLabel(getInfoProducteur(producteurDTO), ContentMode.HTML);
	...
	private void addFieldDocuments()
	{
		...
		addComboEnumField("Ce producteur utilise des contrats d'engagement", "contratEngagement").setReadOnly(true);
		
		addSearcher("Contrat d'engagement", "idEngagement", SearcherList.ENGAGEMENT ,null).setReadOnly(true);
