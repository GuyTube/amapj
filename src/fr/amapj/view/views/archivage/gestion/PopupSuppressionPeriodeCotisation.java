...
public class PopupSuppressionPeriodeCotisation extends WizardFormPopup
{
	...
	private void addFieldSaisieContrat()
	{
		...
		if (dtos.size()==0)
		{
			addLabel("Il n'y a pas de périodes de cotisation à supprimer.",  ContentMode.HTML);
			setBackOnlyMode();
			return;
		}
	...
	private void addFieldConfirmation()
	{
		...
		addLabel("Vous allez supprimer DEFINITIVEMENT "+toSuppress.size()+" periodes de cotisation", ContentMode.HTML);
