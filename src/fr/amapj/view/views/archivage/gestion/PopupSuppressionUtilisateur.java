...
public class PopupSuppressionUtilisateur extends WizardFormPopup
{
	...
	private void addFieldSaisieContrat()
	{
		...
		if (dtos.size()==0)
		{
			addLabel("Il n'y a pas d'utilisateurs à supprimer.",  ContentMode.HTML);
			setBackOnlyMode();
			return;
		}
	...
	private void addFieldConfirmation()
	{
		...
		addLabel("Vous allez supprimer DEFINITIVEMENT "+toSuppress.size()+" utilisateurs", ContentMode.HTML);
