...
public class MenuInfo 
{
	...
	private MenuInfo()
	{
		...
		// Partie archives
		menus.add(new MenuDescription(MenuList.CONTRAT_ARCHIVE,  ArchivageContratListPart.class , RoleList.REFERENT ).setCategorie("ARCHIVES"));
		menus.add(new MenuDescription(MenuList.PRODUCTEUR_ARCHIVE,  ArchivageProducteurListPart.class , RoleList.TRESORIER ));
		menus.add(new MenuDescription(MenuList.UTILISATEUR_ARCHIVE,  ArchivageUtilisateurListPart.class , RoleList.TRESORIER ));
		menus.add(new MenuDescription(MenuList.GESTION_ARCHIVE,  GestionArchivageView.class , RoleList.TRESORIER ));
