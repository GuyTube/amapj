...
public class EGFeuilleEmargement  extends AbstractExcelGenerator
{
	...
	public EGFeuilleEmargement(Long modeleContratId)
	{
	...
	{	
		EGGrilleEmargementTool grilleTool = new EGGrilleEmargementTool();
		...
		grilleTool.performSheet(et,"Feuille d'Emargement","Amap",mc,prods,dates,utilisateurs,nbColGauche,contrats);
	}
	...
	{
		ModeleContrat mc = em.find(ModeleContrat.class, modeleContratId);
		return "feuilleEmargement-"+mc.getNom();
	}
	...
	{
		return "Feuille d'émargement pour signature des contrats";
	}
	...
	{
		new EGFeuilleEmargement(11252L).test(); 
	}
