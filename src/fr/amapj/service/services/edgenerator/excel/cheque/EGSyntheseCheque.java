...
public class EGSyntheseCheque extends AbstractExcelGenerator
{
	 ...
	 */
	public void addOneSheet(EntityManager em, Utilisateur u, ExcelGeneratorTool et,String pageName,boolean orderByName)
	{
	...
	private void drawBlocDate(EntityManager em, ExcelGeneratorTool et, Contrat c, List<Paiement> paiements, SimpleDateFormat df1)
	{
