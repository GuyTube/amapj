...
public class EGStatPeriodeContratAdherent extends AbstractExcelGenerator
{
	...
	private void fillTab(EntityManager em, ExcelGeneratorTool et, PeriodeCotisationDTO periode)
	{
	...
	private List<Contrat> getContrat(EntityManager em,Long idPeriodeCotisation)
	{
	...
	private void addRow(ModeleContrat mc, List<List<Contrat>> contrats, ExcelGeneratorTool et, EntityManager em)
	{
		et.addRow();
